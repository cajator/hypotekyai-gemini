...
// Finální oprava - Vrácení původní detailní logiky a použití stabilního modelu `gemini-pro`

import { GoogleGenerativeAI } from "@google/generative-ai";

// TATO FUNKCE JE OBNOVENA Z VAŠÍ PŮVODNÍ VERZE, ABY SE ZACHOVALA DETAILNÍ LOGIKA
...
const handler = async (event) => {
    ...
    try {
        ...
        // FINÁLNÍ OPRAVA: Použití nejstabilnějšího modelu gemini-pro
        ...
        if (jsonMatch) {
            try {
                ...
                // Pokračovat s textovou odpovědí
            }
        }
