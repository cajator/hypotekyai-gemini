...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const CONFIG = {
        ...
        AI_SUGGESTIONS: {
            initial: ["Chci spočítat hypotéku", "Jaké jsou aktuální úrokové sazby?", "Co je to LTV?"],
            contextual: {
    ...
    const handleChatMessageSend = async (message) => {
        ...
        try {
            ...
            if (data.tool === 'goToCalculator') { switchMode('express'); if (data.params) { Object.assign(state.formData, data.params); DOMElements.contentContainer.innerHTML = getExpressHTML(); calculateRates(); } }
